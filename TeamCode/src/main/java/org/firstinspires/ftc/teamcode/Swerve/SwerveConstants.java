...
public final class SwerveConstants {
    ...
    public static double TurnKf = 0.0;

    public static double TRACK_WIDTH = 16;
    public static double TRACK_LENGTH = 16;

    // absolute encoder voltage range, min -> max, over a full 360 degree sweep
    ...
    public static final boolean LEFT_FRONT_ENCODER_REVERSED = false;
    public static final boolean LEFT_BACK_ENCODER_REVERSED = false;
    public static final boolean RIGHT_FRONT_ENCODER_REVERSED = false;
    public static final boolean RIGHT_BACK_ENCODER_REVERSED = false;

    public static final boolean LEFT_FRONT_DRIVE_REVERSED = false;
    public static final boolean LEFT_BACK_DRIVE_REVERSED = false;
    public static final boolean RIGHT_FRONT_DRIVE_REVERSED = false;
    public static final boolean RIGHT_BACK_DRIVE_REVERSED = false;
}
